function solution(a, b, c, d) {
    ...
    for (let [key, value] of diceCount) {
        ...
        if (value === 2 && diceCount.length === 2) answer = (diceCount[0][0] + diceCount[1][0]) * Math.abs(diceCount[0][0] - diceCount[1][0]);
        // 두 주사위의 숫자가 같으면서 중복 값을 포함하여 3세트인 경우 예) [[2, 2], [5, 1], [6, 1]]
        if (value === 2 && diceCount.length === 3) answer = diceCount[1][0] * diceCount[2][0];
